            ...
            <div class="container">
                ...
                <div class="page__store-box">
                    ...
                    $cal_args = array(
                        ...
                        'meta_query' => array(
                            array(
                                'key' => 'store_is_calsmotor', // The name of the ACF field
                    ...
                    if($cal_query -> have_posts()){
                        while($cal_query -> have_posts()){
                            ...
                            $cal_cats = get_the_terms(get_the_id(), 'store_category');
                            
                            if ($cal_cats && !is_wp_error($cal_cats)) { // Check if terms are available and not an error
                                foreach ($cal_cats as $cat) {
                                    if (!array_key_exists($cat -> term_id, $store_terms)) { // Ensure unique terms
                                        $store_terms[$cat -> term_id] = $cat;
                                    }
                                }
                            }
                        }
                    ...
                    $store_terms = array_values($store_terms);
