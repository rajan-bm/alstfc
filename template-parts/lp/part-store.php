    ...
    <section class="store">
        <div class="container--md">
            <div class="store__wrapper">
                <div class="store__ttl">
                    <p class="store__ttl-text">店舗からレンタカーを探す</p>
                </div>
                <div class="store__row">
                    <div class="store__col">
                        <div class="store__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/store-map.svg" alt="STORE MAP" width="565" height="630" loading="lazy" class="img-fluid">
                                    ...
                                    <a href="#" class="store__img-link acctrigger" data-accordion="acc-<?php echo (1 + $i); ?>">
                                        ...
                                        <span class="store__img-link-inner">
                                            <?php 
                                                ...
                                                $total_term_posts = $store_query -> post_count; ?>
                                            <span>
                                                <span class="store__img-link-blue"><?php echo $total_term_posts; ?></span><span class="store__img-link-black">店舗</span>
                                            </span>
                                            <span>
                    ...
                    <div class="store__col store__col--bg">
